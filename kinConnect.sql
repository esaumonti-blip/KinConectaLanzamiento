...
-- Schema kin_conecta
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `KCv2` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ;
-- USE `KCv2` ;
-- DROP SCHEMA KCv2;
...
-- -----------------------------------------------------
-- CREATE TABLE IF NOT EXISTS `KCv2`.`income_transactions` (
...
-- -----------------------------------------------------
-- CREATE TABLE IF NOT EXISTS `KCv2`.`newsletter_subscriptions` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`languages` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`users` (
  ...
  CONSTRAINT `fk_users_language`
    ...
    REFERENCES `KCv2`.`languages` (`language_code`)
    ON DELETE SET NULL
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`auth_sessions` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`tourist_profiles` (
  `user_id` BIGINT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`guide_profiles` (
  `user_id` BIGINT UNSIGNED NOT NULL,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`tourist_profile_languages` (
  `user_id` BIGINT UNSIGNED NOT NULL,
  `language_code` CHAR(8) NOT NULL,
  ...
  CONSTRAINT `fk_tpl_user`
    FOREIGN KEY (`user_id`)
    REFERENCES `KCv2`.`tourist_profiles` (`user_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`guide_profile_languages` (
  `user_id` BIGINT UNSIGNED NOT NULL,
  `language_code` CHAR(8) NOT NULL,
  PRIMARY KEY (`user_id`, `language_code`),
  ...
  CONSTRAINT `fk_gpl_user`
    FOREIGN KEY (`user_id`)
    REFERENCES `KCv2`.`guide_profiles` (`user_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`interests` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`tourist_profile_interests` (
  `user_id` BIGINT UNSIGNED NOT NULL,
  ...
  CONSTRAINT `fk_tpi_interest`
    ...
    REFERENCES `KCv2`.`interests` (`interest_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
SELECT * FROM tourist_profile_interests;

-- -----------------------------------------------------
-- Table `kin_conecta`.`guide_expertise_areas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`guide_expertise_areas` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`guide_profile_expertise` (
  `user_id` BIGINT UNSIGNED NOT NULL,
  ...
  CONSTRAINT `fk_gpe_expertise`
    ...
    REFERENCES `KCv2`.`guide_expertise_areas` (`expertise_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`guide_locations` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`guide_certifications` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`guide_adaptations` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`tour_categories` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`tours` (
  ...
  CONSTRAINT `fk_tours_category`
    ...
    REFERENCES `KCv2`.`tour_categories` (`category_id`)
    ON DELETE SET NULL
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`tour_included_items` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`tour_destinations` (
  `tour_id` BIGINT UNSIGNED NOT NULL,
  ...
  CONSTRAINT `fk_tour_destinations_destination`
    ...
    REFERENCES `KCv2`.`destinations` (`destination_id`)
    ON DELETE RESTRICT
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`trip_bookings` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`trip_status_history` (
  ...
  CONSTRAINT `fk_trip_status_history_trip`
    FOREIGN KEY (`trip_id`)
    REFERENCES `KCv2`.`trip_bookings` (`trip_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`guide_calendar_events` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`favorite_guides` (
  `tourist_id` BIGINT UNSIGNED NOT NULL,
  `guide_id` BIGINT UNSIGNED NOT NULL,
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`favorite_tours` (
  `tourist_id` BIGINT UNSIGNED NOT NULL,
  `tour_id` BIGINT UNSIGNED NOT NULL,
  `created_at` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`reviews` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`review_replies` (
  ...
  CONSTRAINT `fk_review_replies_review`
    ...
    REFERENCES `KCv2`.`reviews` (`review_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`chat_threads` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`chat_messages` (
  ...
  CONSTRAINT `fk_chat_messages_thread`
    ...
    REFERENCES `KCv2`.`chat_threads` (`thread_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`notifications` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`support_tickets` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`support_ticket_attachments` (
  ...
  CONSTRAINT `fk_support_ticket_attachments_ticket`
    ...
    REFERENCES `KCv2`.`support_tickets` (`ticket_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`faq_categories` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`faq_items` (
  ...
  CONSTRAINT `fk_faq_items_category`
    ...
    REFERENCES `KCv2`.`faq_categories` (`faq_category_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`withdrawal_requests` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`compatibility_profiles` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`compatibility_answers` (
  ...
  CONSTRAINT `fk_compatibility_answers_profile`
    ...
    REFERENCES `KCv2`.`compatibility_profiles` (`compatibility_profile_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KCv2`.`contact_messages` (
